...
class ReadMode extends StatefulWidget {
  final Diary diary;

  ReadMode({required this.diary});

  @override
  _ReadModeState createState() => _ReadModeState();
}

class _ReadModeState extends State<ReadMode> {
          ...
          IconButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => EditDiaryScreen(diary: widget.diary)),
              );
            },
